...
const TYPES = [
  ...
  },
  {
    value:       'voz-basico',
    label:       'Voz Básico',
    tagline:     'Agente de voz simple',
    description: 'Responde llamadas entrantes con respuestas predefinidas. Sin integraciones externas.',
    icon:        Phone,
    color:       '#F59E0B',
    model:       'gpt-4o-mini',
    maxTokens:   500,
    features:    ['Llamadas entrantes', 'System prompt personalizado', 'Deepgram STT + TTS'],
  },
  {
    value:       'voz-intermedio',
    label:       'Voz Intermedio',
    tagline:     'Conectado a sistemas externos',
    description: 'Consulta CRMs, bases de datos y APIs durante la llamada via n8n.',
    icon:        Phone,
    color:       '#F97316',
    model:       'gpt-4o-mini',
    maxTokens:   1500,
    features:    ['Todo lo del Voz Básico', 'Integración n8n', 'Llamadas salientes'],
  },
  {
    value:       'voz-avanzado',
    label:       'Voz Avanzado',
    tagline:     'Acciones reales en llamada',
    description: 'Agenda citas, procesa pagos y ejecuta flujos complejos durante la conversación.',
    icon:        Phone,
    color:       '#EF4444',
    model:       'gpt-4o',
    maxTokens:   4000,
    features:    ['Todo lo del Voz Intermedio', 'Agenda citas en llamada', 'Transferencia a humano'],
  },
]
